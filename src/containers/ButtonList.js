        ...
        return(
           <div className='row'>
               ...
               <div className='col-sm-3'>
                   ...
                   <button className='btn-block btn-lg btn-default' onClick={() => { this.props.pressEqual()}}>=</button>
               </div>
           </div>
        )
    }
...
function mapDispatchToProps (dispatch){
    return bindActionCreatros({pressButton, pressEqual, pressReset}, dispatch)
}
